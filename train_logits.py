...
parser.add_argument('--s_init', type=str, default='./results/baseline_r20_000.ckp', required=False, help='initial parameters of student model')
...
parser.add_argument('--s_name', type=str,  default='resnet20',required=False, help='name of student')
